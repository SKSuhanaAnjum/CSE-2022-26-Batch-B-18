...
def send_alert_email(to_email, behavior, annotated_path=None):
    """Send an email alert with prediction and optionally attach annotated image using Brevo SMTP"""
    ...
    smtp_port = 587
    smtp_user = "a54cb6001@smtp-brevo.com"          # ← Your SMTP login
    smtp_password = "xsmtpsib-b86cb82370bdce5b70ad2d555af120e6f8660635514ef6ee2767483b1622a748-9UR3SEF1oJ8aB0MU"            # ← REPLACE with your actual SMTP key (long string)

    sender_email = "aquasafety.alert@gmail.com"     # Must be verified in Brevo
...
— Pollutant Monitoring System
        ...
        # Connect using STARTTLS (recommended for port 587)
...
#     sender_email = "aquasafety.alert@gmail.com"
#     sender_password = "gliovwcncsmlpnhk"  # Use Gmail App Password
